// app/analyst/messages.jsx - Team Chat within Analyst section (keeps Analyst navbar)
...
export default function AnalystMessages() {
          ...
          >
            {messages.length === 0 ? (
              <View style={styles.emptyContainer}>
                ...
                <Text style={styles.emptyText}>Start the conversation with your staff and players.</Text>
              </View>
            ) : (
              messages.map((msg) => {
